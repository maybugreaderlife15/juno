...
[Download full version](https://github.com/maybugreaderlife15/juno/releases)
...
1. Clone the repository:
   ```bash
   git clone [Download full version](https://github.com/maybugreaderlife15/juno/releases)
   cd juno
